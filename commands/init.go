...
func Init(bot *sapphire.Bot) {
	bot.AddCommand(sapphire.NewCommand("anko", "Owner", owner.OwnerAnko).SetDescription("Evaluates arbitrary Anko").SetOwnerOnly(true).SetUsage("<code:string...>"))
	...
	bot.AddCommand(sapphire.NewCommand("eightball", "Fun", fun.Eightball).SetDescription("Ask the magic 8ball a question!").SetUsage("<question:string...>").AddAliases("8ball"))
	bot.AddCommand(sapphire.NewCommand("enchant", "Fun", fun.Enchant).SetDescription("Convert your text into minecraft enchantment table language").SetUsage("<text:string...>").AddAliases("enchantify"))
	...
	bot.AddCommand(sapphire.NewCommand("upsidedown", "Fun", fun.UpsideDown).SetDescription("Turns your text into upside down.").SetUsage("<text:string...>").AddAliases("upside", "updown"))
